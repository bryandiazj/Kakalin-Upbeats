...
func _select_track(msg: Dictionary) -> void:
	if msg.name == "Disco_Lounge":
		msg.name = "Disco Lounge"
	if msg.name == "Secret_of_Life":
		msg.name = "Secret of Life"
	if msg.name == "Rebel_Yell":
		msg.name = "Rebel Yell"
	if msg.name == "Die_Prinzen":
		msg.name = "Die Prinzen"
