...
func _ready():
	...
	if len(scores) > 0: 
		...
		print(Global.save_track.name)
		yield(SilentWolf.Scores.get_high_scores(10, Global.save_track.name), "sw_scores_received")
		hide_message()
...
#	get_tree().change_scene(scene_name)
	...
	get_tree().change_scene("res://RhythmGameDemo.tscn")	
